            ...
            <div class="ui container">
                <div className="main-header mt-2">
                    <h2 class="ui icon center aligned header">
                        <div className="mt-3">
                            <img src="/images/phones.png" width="130"/>
                        </div>

                        <div class="content title">Planeta Celulares</div>
                    </h2>
                </div>
                <div class="ui grid">
                    <h1 className="mycart-header">Añadir<br />a la cesta</h1>
                    ...
                    <div class="right floated five wide column">
                        <DndProvider backend={HTML5Backend} >
                            <div class="ui row">
                                <h3 class="brand-heading">Celulares Disponibles</h3>
                            </div>
                            <div class="ui row">
